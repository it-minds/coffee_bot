...
const ChannelMessagesForm: FC<Props> = ({ submitCallback, channelId }) => {
  ...
  const validateFields = useCallback(() => {
    ...
    valid[0] &&= /{{\s*[rR]ound[sS]tart[tT]ime\s*}}/g.test(localFormData["roundStartChannelMessage"]);
    ...
    <Flex w="full" align="center" justifyContent="center">
      <Box width="md" opacity={isLoading ? 0.2 : 1}>
        <Text>
          ...
          <UnorderedList my={5}>
            <ListItem>&#123;&#123; MeetupPercentage &#125;&#125;: Will print the number representing the percent of people who have met up for coffee so far this round</ListItem>
            <ListItem>&#123;&#123; MeetupCondition &#125;&#125;: Will print the line "Next time, let's try for 100% shall we?" if MeetupPercentage is not 100%</ListItem>
            <ListItem>&#123;&#123; RoundStartTime &#125;&#125;: Will print the start date for the round</ListItem>
            <ListItem>&#123;&#123; RoundEndTime &#125;&#125;: Will print the end date for the round</ListItem>
            <ListItem>&#123;&#123; Groups &#125;&#125;: Wil print the list of all groups</ListItem>
          </UnorderedList>
          And the following two only work in the "Midway Message"
          <UnorderedList>
            <ListItem>&#123;&#123; YesButton &#125;&#125;: Specifies where in the message the yes button will be</ListItem>
            <ListItem>&#123;&#123; NoButton &#125;&#125;: Specifies where in the message the no button will be</ListItem>
          </UnorderedList>
        ...
        <form onSubmit={onSubmit}>
          <FormControl mt={5} isRequired isInvalid={!validFields[0]}>
            ...
            <Textarea
              ...
              />
              <FormErrorMessage>This message must contain the following tags: &#123;&#123; RoundStartTime &#125;&#125;, &#123;&#123; RoundEndTime &#125;&#125; and &#123;&#123; Groups &#125;&#125;</FormErrorMessage>
          </FormControl>
          <FormControl isRequired isInvalid={!validFields[1]}>
            ...
            <Textarea
              ...
              />
              <FormErrorMessage>This message must contain the following tags: &#123;&#123; RoundStartTime &#125;&#125; and &#123;&#123; RoundEndTime &#125;&#125;</FormErrorMessage>
          </FormControl>
          <FormControl isRequired isInvalid={!validFields[2]}>
            ...
            <Textarea
              ...
              />
              <FormErrorMessage>This message must contain the following tags: &#123;&#123; YesButton &#125;&#125; and &#123;&#123; NoButton &#125;&#125;</FormErrorMessage>
          </FormControl>
